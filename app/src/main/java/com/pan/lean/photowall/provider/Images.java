...
package com.pan.lean.photowall.provider;
...
public class Images {
     ...
     */
    public final static ImageWorker.ImageWorkerAdapter imageThumbWorkerUrlsAdapter =
            new ImageWorker.ImageWorkerAdapter() {
                @Override
                public Object getItem(int num) {
